...
- 25 slides in English, 16:9: 19 paper/exercise slides followed by exactly 6 Lean slides.
...
- Automated layout audit: no warnings. All 25 rendered slides and the contact sheet were individually visually inspected.
- Audit artifacts: `.tmp/requirements-final/audit_report.md`, `.tmp/requirements-final/contact_sheet.png`, and `.tmp/requirements-final/pages/` (local ignored previews).
...
- Remaining requirement: genuine handwritten photograph, explicitly pending on slide 18. Supplying hand/derivation.jpg and rebuilding inserts it automatically.
