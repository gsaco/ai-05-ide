...
| [presentation-requirements.md](presentation-requirements.md) | Assignment requirements mapped to slide numbers, including the genuine hand photographs. |
...
See [submission-audit.md](submission-audit.md) for the final requirement audit and unresolved provenance conditions.
