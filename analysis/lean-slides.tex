...
\begin{frame}[fragile]{Lean 4/6: paper equation, contract, and checked proof}
\[n(z)=\frac1{h(1-z)},\qquad n(z)(a-w)-r=0
\ \Longrightarrow\ w=a-h(1-z)r.\]
\lstinputlisting[firstline=22,lastline=24,basicstyle=\ttfamily\footnotesize]{lean/FirmAlgebra.lean}
\lstinputlisting[firstline=28,lastline=32,basicstyle=\ttfamily\footnotesize]{lean/FirmAlgebra.lean}
\small
$h$: helping cost; $z$: worker knowledge; $a$: AI capability; $w$: wage; $r$: rent.\par
\texttt{field\_simp} clears nonzero denominators; \texttt{nlinarith} finishes.\par
\textbf{\texttt{zeroProfitWage}: PASS.} Arbitrary real $a,w,r$ broaden the source domain; zero profit is assumed and equilibrium is not proved.
\end{frame}
