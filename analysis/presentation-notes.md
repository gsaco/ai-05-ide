...
24 English slides: 18 on the paper and finite exercise, followed by exactly 6 on Lean. Navy titles, teal blocks, light backgrounds, and no slide footer notes. Detailed references and oral explanations stay here.
...
| 9 | Proposition 6: bottom, top, and total output | 0:50 | 5:45 |
| 10 | Why autonomy changes the distribution | 0:55 | 6:40 |
| 11 | A three-type economy we can solve directly | 0:55 | 7:35 |
| 12 | Autonomous AI: solve one equilibrium branch | 1:00 | 8:35 |
| 13 | Same autonomy, different bottom outcomes | 0:50 | 9:25 |
| 14 | Numerical results separate the two dimensions | 0:35 | 10:00 |
| 15 | More output does not imply more labor income | 0:40 | 10:40 |
| 16 | What the computational check establishes | 0:50 | 11:30 |
| 17 | The claim I would not accept without checking | 0:40 | 12:10 |
| 18 | What the paper and the example teach us | 0:25 | 12:35 |
| 19 | Lean 1/6: from economics to a precise statement | 0:45 | 13:20 |
| 20 | Lean 2/6: the bottom-gain threshold | 1:20 | 14:40 |
| 21 | Lean 3/6: why the inequality proof works | 1:10 | 15:50 |
| 22 | Lean 4/6: zero profit implies a wage identity | 1:15 | 17:05 |
| 23 | Lean 5/6: a missing assumption changes the claim | 1:00 | 18:05 |
| 24 | Lean 6/6: what passed and what remains open | 1:55 | 20:00 |
...
**Slide 10.** For a fixed human–AI team, r=a reflects the compute owner's autonomous production opportunity; r=0 reflects abundant compute restricted to advising. Substituting in the same zero-profit equation isolates this opportunity-cost channel. Neither formula alone ranks all equilibrium wages, because humans may switch roles or partners. The original Lean run proves the algebraic substitutions conditionally.

**Slide 16.** A contains resource requirements for production activities, b contains human masses and compute supply, and q contains expected output. The dual vector p contains human wages and the AI rental. Feasible allocations and prices with equal objectives certify the finite optimum. Separate minimization and maximization of each wage over the optimal dual face check uniqueness. Explain these objects orally; the slide is deliberately compact.
